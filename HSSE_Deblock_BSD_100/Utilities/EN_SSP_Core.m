...
function [Imout] = EN_SSP_Core(InputImage, Opts)
...
for  i  =  1 : NN
    ...
    for  j  =  1 : MM
           ...
           currow              =              row(i);
            ...
            lambda             =               repmat ( 2*sqrt(2)*Opts. c2 *Opts.nSig^2./(sqrt(s0)+eps),[1, size(A0,2)]); %Generate the weight Eq.(19)
        
           Alpha               =               soft (A0, lambda);  % L0_norm
